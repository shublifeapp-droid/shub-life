...
export const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    monthlyPrice: 0,
    studentLimit: 10,
    features: ["Até 10 alunos", "Dashboard básico", "Programa Partner"],
  },
  {
    code: "personal_pro",
    audience: "personal",
    ...
    monthlyPrice: 29.9,
    studentLimit: 30,
    features: ["Até 30 alunos", "Carteira completa", "Relatórios"],
  },
  {
    ...
    monthlyPrice: 49.9,
    studentLimit: 100,
    features: ["Até 100 alunos", "IA de evolução", "Suporte prioritário"],
  },
];
